...
import { a as MarkerSeverity, c as Range, d as Token, f as Uri, h as languages, i as KeyMod, l as Selection, m as editor_api2_exports, n as Emitter, o as MarkerTag, p as editor, r as KeyCode, s as Position, t as CancellationTokenSource, u as SelectionDirection } from "./editor.api2-KmmoZ-8W.js";
import { t as monaco_contribution_exports$3 } from "./monaco.contribution-jOiy-AID.js";
import { t as createWebWorker } from "./workers-DSnnuyUc.js";
import "/data/data/com.termux/files/home/txb-workspace/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon.css";
import "/data/data/com.termux/files/home/txb-workspace/node_modules/monaco-editor/esm/vs/base/browser/ui/codicons/codicon/codicon-modifiers.css";
...
function getMode$2() {
	return import("./cssMode-BRbsygBa.js");
}
...
function getMode$1() {
	return import("./htmlMode-pSShFkiy.js");
}
...
function getMode() {
	return import("./jsonMode-BXsGlODA.js");
}
languages.register({
	id: "json",
	extensions: [
...
registerLanguage({
	...
	extensions: [".abap"],
	aliases: ["abap", "ABAP"],
	loader: () => import("./abap-Di7XgicZ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./apex-C5C7qIZE.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./azcli-nvaziAiI.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".bicep"],
	aliases: ["Bicep"],
	loader: () => import("./bicep-B-yErJbJ.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".mligo"],
	aliases: ["Cameligo"],
	loader: () => import("./cameligo-C9hmLvd8.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./clojure-CDw2WRw7.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./coffee-DleXElXs.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["C#", "csharp"],
	loader: () => import("./csharp-Dpbs3fgB.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./cypher-aThB-Vhw.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./dart-BKbIoDDb.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Dockerfile"],
	loader: () => import("./dockerfile-3iglUKk5.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./elixir-CjIoPYLA.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./flow9-JCHTmqC8.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./fsharp-Cj3AH2q-.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagAutoInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagAngleInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagBracketInterpolationDollar);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagAngleInterpolationBracket);
	}
});
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagBracketInterpolationBracket);
	}
});
registerLanguage({
...
registerLanguage({
	...
	loader: () => {
		return import("./freemarker2-C1PJfKWi.js").then((m) => m.TagAutoInterpolationBracket);
	}
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./graphql-CuAkjdim.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./handlebars-CBeg4QGF.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./html-BiUgAN-V.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./java-CvhA5JQe.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./javascript-CK9YJVlV.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".jl"],
	aliases: ["julia", "Julia"],
	loader: () => import("./julia-CHh9puZR.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./kotlin-ZEa5-7Of.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./less-r0TZ8BRO.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".lex"],
	aliases: ["Lexon"],
	loader: () => import("./lexon-BTx4cNWm.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./liquid-DaJpXkLp.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./markdown-CRnBivzL.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./mips-CgrGSbPc.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["DAX", "MSDAX"],
	loader: () => import("./msdax-DN8t-s2V.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [],
	aliases: ["MySQL", "mysql"],
	loader: () => import("./mysql-BJTnWIgI.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".m"],
	aliases: ["Objective-C"],
	loader: () => import("./objective-c-I9b5Uo9D.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascal-U2cqLO2b.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pascaligo-BZ4VLZ3j.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".pl", ".pm"],
	aliases: ["Perl", "pl"],
	loader: () => import("./perl-C8xHjKB0.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./pgsql-hTczISBy.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./postiats-CXLxSyRo.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powerquery-BoMHoZkg.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./powershell-CGLxH0VQ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./protobuf-4um8j79o.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./python-JyIuqPfX.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".qs"],
	aliases: ["Q#", "qsharp"],
	loader: () => import("./qsharp-B3hXa1Ll.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./razor-LIY6HKF-.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".redis"],
	aliases: ["redis"],
	loader: () => import("./redis-CQiAJsYJ.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./redshift-x_eh46sU.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./restructuredtext-DJX1d9cL.js")
});
//#endregion
...
registerLanguage({
	...
	aliases: ["Ruby", "rb"],
	loader: () => import("./ruby-6lW7tVMC.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".rs", ".rlib"],
	aliases: ["Rust", "rust"],
	loader: () => import("./rust-BcDXkWaz.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scala-vgpR2HYi.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scheme-DKNPe8Di.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./scss-eVrqS8_j.js")
});
//#endregion
...
registerLanguage({
	...
	extensions: [".sh", ".bash"],
	aliases: ["Shell", "sh"],
	loader: () => import("./shell-CE16xL-z.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./solidity-dQsl-KlX.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sophia-Bn4_zjvF.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./sparql-DC8faDIA.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./swift-Cr1q6UUX.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./systemverilog-Dar7ltF1.js")
});
registerLanguage({
	id: "verilog",
	extensions: [".v", ".vh"],
...
registerLanguage({
	...
	loader: () => import("./twig-D1WQx9-3.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => {
		return import("./typescript-CGeXlcCf.js");
	}
});
//#endregion
...
registerLanguage({
	...
	extensions: [".tsp"],
	aliases: ["TypeSpec"],
	loader: () => import("./typespec-BvYBN2Mv.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./wgsl-B7BVfP-Y.js")
});
//#endregion
...
registerLanguage({
	...
	loader: () => import("./yaml-hzI_Gi9m.js")
});
//#endregion
